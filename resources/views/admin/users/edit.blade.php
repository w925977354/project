                ...
                <div class="p-8">
                    <form action="{{ route('admin.users.update', $user) }}" method="POST" class="space-y-6">
                        ...
                        <div class="bg-gray-50 rounded-lg p-4">
                            <h4 class="text-sm font-semibold text-gray-700 mb-2">User Statistics</h4>
                            <div class="grid grid-cols-2 gap-4 text-sm">
                                <div>
                                    <span class="text-gray-500">Total Photos:</span>
                                    <span class="font-semibold text-gray-900">{{ $user->photos->count() }}</span>
                                </div>
                                <div>
